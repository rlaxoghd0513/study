...
if __name__ == '__main__':
    ...
    num_classes = 2
    dataset = PennFudanDataset('D:\mask\PennFudanPed', get_transform(train=True))
    dataset_test = PennFudanDataset('D:\mask\PennFudanPed', get_transform(train=False))
    ...
    print('1')
# device = torch.decive('cuda') if torch.cuda.is_available() else torch.device('cpu')
# num_classes = 2
# dataset = PennFudanDataset('D:\mask\PennFudanPed', get_transform(train=True))
# dataset_test = PennFudanDataset('D:\mask\PennFudanPed', get_transform(train=False))
