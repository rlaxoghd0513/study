...
plt.subplot(2,2,1)    #2,2짜리 subplot만든다  그리고 첫번째에 그림 넣는다
plot_feature_importances(model1)
plt.subplot(2,2,2)    #2,2짜리 subplot만든다  그리고 첫번째에 그림 넣는다
plot_feature_importances(model2)
plt.subplot(2,2,3)    #2,2짜리 subplot만든다  그리고 첫번째에 그림 넣는다
plot_feature_importances(model3)
plt.subplot(2,2,4)    #2,2짜리 subplot만든다  그리고 첫번째에 그림 넣는다
