...
import numpy as np
from sklearn.datasets import load_iris,load_diabetes,load_breast_cancer, load_wine, load_digits, fetch_covtype
...
def lgb_hamsu(max_depth, learning_rate, subsample, colsample_bytree):
    ...
    model = XGBRegressor(**params) #한꺼번에 넣는다
    ...
    result = -1*np.sqrt(mean_squared_error(y_test,y_predict))
