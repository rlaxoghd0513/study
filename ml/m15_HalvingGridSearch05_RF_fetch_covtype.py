import numpy as np
from sklearn.datasets import load_iris, load_digits, load_breast_cancer, load_wine, fetch_covtype
...
model = HalvingGridSearchCV(RandomForestClassifier(), parameters,            #cross_val 당 52 중 10개만 랜덤하게 뽑겠다 데이터가 크다 싶으면 randomized 데이터가 작아서 금방 끝나겠다 싶으면 gridsearch
...
print("최적 튠:",accuracy_score(y_test,y_pred_best)) 

print("걸린시간:", round(end_time-start_time,2), '초')

# 최적의 매개변수: RandomForestClassifier(max_depth=12, n_estimators=200)
# 최적의 파라미터: {'max_depth': 12, 'n_estimators': 200}
# best_score: 0.7778990963855422
# model.score: 0.7824927067287419
# acc: 0.7824927067287419
# 최적 튠: 0.7824927067287419
# 걸린시간: 428.78 초