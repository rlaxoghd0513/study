...
#3 컴파일 훈련
model.set_params(**parameter, eval_metrics = 'mae', early_stopping_rounds = 200) # model.compile이라고 생각하면 된다
...
submission.to_csv(path_save+'submit_0501_1435.csv') #csv로 내보내기
