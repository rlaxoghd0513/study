...
def lgb_hamsu(max_depth, num_leaves, learning_rate, min_child_samples, min_child_weight, subsample, colsample_bytree, max_bin, reg_lambda, reg_alpha):
    ...
    model = LGBMClassifier(**params) #한꺼번에 넣는다
...
# {'target': 0.9649122807017544, 'params': {'colsample_bytree': 0.5, 'learning_rate': 0.3, 'max_bin': 66.10521621314285, 'max_depth': 3.0, 'min_child_samples': 68.75171044078137, 'min_child_weight': 1.0, 'num_leaves': 64.0, 'reg_alpha': 0.01, 'reg_lambda': -0.001, 'subsample': 1.0}}
# 100 번 걸린시간: 36.081018924713135
