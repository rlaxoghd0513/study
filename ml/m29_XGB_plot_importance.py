...
######################################################################
#하이퍼파라미터 튜닝이 되있는 최상위 값에서 돌려야됨
#칼럼 삭제하고 다시 돌려야한다 칼럼갯수가 10개면 8개도 지워보고 9개도 지워본다
#성능이 좋으면 사용하고 안좋으면 칼럼 삭제 안한다
...
plot_importance(model)  #모델의 가중치 다 들어가 있다
plt.show() #칼럼별 중요한 순서대로