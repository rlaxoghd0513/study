...
from sklearn.linear_model import LogisticRegression ###### regressor 가 이름에 들어있긴 하지만 얘는 분류모델이다
...
#kaggle_bike  DecisionTreeRegressor 0.89   RandomForestRegressor 0.83
#california   DecisionTreeRegressor 1.00   RandomForestRegressor 0.97
#ddaung       DecisionTreeRegressor 1.00   RandomForestRegressor 0.96
