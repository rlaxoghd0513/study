...
model = Sequential()
model.add(Conv2D(16,(3,3), input_shape=(6,3,3), padding='same'))
...
model.fit(x_train, y_train, batch_size=32, epochs=1000, validation_split=0.2,verbose=1, callbacks=[es]) #배치가 크면 터진다
...
# acc: 0.7127957109541062
# results: [0.6808649897575378, 0.6947410702705383]
