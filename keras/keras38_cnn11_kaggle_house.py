...
from tensorflow.python.keras.layers import MaxPool2D, Dense, Input, Dropout, Flatten, Conv2D
...
x_train = x_train.reshape(1314,13,6,1)
x_test = x_test.reshape(146,13,6,1)

test_csv = test_csv.reshape(1459,13,6,1)



#2 모델구성
input1 = Input(shape = (13,6,1))
conv1 = Conv2D(64, 3, padding='same')(input1)
conv2 = Conv2D(64, 3, padding='valid')(conv1)
