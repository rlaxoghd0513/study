...
path_save = 'd:/study_data/_save/cat_dog_flow/'
...
np.save(path_save +'keras58_8_x_train.npy', arr = x_train)
np.save(path_save +'keras58_8_x_test.npy', arr = x_test)
np.save(path_save +'keras58_8_y_train.npy', arr = y_train)
np.save(path_save +'keras58_8_y_test.npy', arr = y_test)
