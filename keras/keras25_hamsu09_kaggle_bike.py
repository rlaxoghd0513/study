...
hist =model.fit(x_train, y_train, batch_size=32, epochs=500, verbose=1,validation_split=0.15, callbacks=[es])
...
#sequential r2스코어: 0.23653303987766705
#           RMSE: 155.53327154529137

#model      r2스코어: 0.2369800315256848
#           RMSE: 155.48773437350837