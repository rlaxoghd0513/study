...
np.save(path_save + 'keras58_3_cifar10_flow_x_train.npy', arr = x_train)
np.save(path_save + 'keras58_3_cifar10_flow_x_test.npy', arr = x_test)
np.save(path_save + 'keras58_3_cifar10_flow_y_train.npy', arr = y_train)
np.save(path_save + 'keras58_3_cifar10_flow_y_test.npy', arr = y_test)