...
from tensorflow.keras.layers import Dense, Input, Dropout, Conv2D, Flatten, LSTM, SimpleRNN, GRU
...
conv1 = GRU(16,return_sequences=True)(input1)
...
hist = model.fit(x_train, y_train, epochs=1, batch_size=1, verbose=1, validation_split=0.2, callbacks=[es,mcp])
