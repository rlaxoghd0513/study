...
from tensorflow.python.keras.layers import Dense, Conv2D, Flatten, Dropout,MaxPooling2D, LSTM,GRU, SimpleRNN
...
model = Sequential()
model.add(LSTM(64, input_shape =(3072,1), return_sequences=True))
