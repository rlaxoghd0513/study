...
conv1 = Conv2D(8, (3,3), padding = 'same')(input1)
conv2 = Conv2D(16,2,padding='same')(conv1)
max1 = MaxPooling2D()(conv2)
conv3 = Conv2D(16,3, activation = 'relu')(max1)
flat = Flatten()(conv3)
dense1 = Dense(16, activation = 'linear')(flat)
...
# results: [0.08635949343442917, 0.9860000014305115]