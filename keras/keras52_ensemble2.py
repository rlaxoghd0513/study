...
x1_train, x1_test, x2_train, x2_test, x3_train, x3_test, y_train, y_test = train_test_split(x1,x2,x3,y, train_size=0.7, random_state=333)  #train_test_split은 3개도 자를수 있다
...
model.fit([x1_train, x2_train, x3_train], y_train, epochs=100, batch_size=32)
...
# loss: 779.2274780273438
# RMSE : 27.91464657471834

# loss: 1718.013916015625
# RMSE : 41.4489313122055

# loss: 54.71240234375
# RMSE : 7.396783299764755