...
print(x_train.shape,x_test.shape)#(300, 100, 100, 1) (120, 100, 100, 1)
print(y_train.shape, y_test.shape)#(300,) (120,)
...
model = Sequential()
model.add(Conv2D(14, (3,3), padding='same', input_shape=(100,100,1)))
