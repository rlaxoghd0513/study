...
from tensorflow.keras.layers import Dense,Input,Dropout,Conv2D, MaxPool2D, Flatten, LSTM
...
Conv1 = LSTM(32,return_sequences =True)(input1)
conv2 = LSTM(16,return_sequences = True)(Conv1)
conv3 = LSTM(16)(conv2)
