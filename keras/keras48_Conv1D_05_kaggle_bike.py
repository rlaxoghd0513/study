...
from tensorflow.python.keras.layers import Dense, Input, Dropout, Conv2D, Flatten, LSTM ,GRU, SimpleRNN, Conv1D
import pandas as pd
...
conv1 = Conv1D(8,2, padding = 'same')(input1)
...
hist =model.fit(x_train, y_train, batch_size=128, epochs=1, verbose=1,validation_split=0.15, callbacks=[es,mcp])
