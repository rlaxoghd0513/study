...
x_train = np.load(path_save + 'keras58_2_mnist_flow_x_train.npy')
y_train = np.load(path_save + 'keras58_2_mnist_flow_y_train.npy')
x_test = np.load(path_save + 'keras58_2_mnist_flow_x_test.npy')
y_test = np.load(path_save + 'keras58_2_mnist_flow_y_test.npy')
